...
namespace comp003bsp25finalprojectvillagranr.Controllers
{
    public class WorkoutsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Date,CaloriesBurned")] Workout workout)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Date,CaloriesBurned")] Workout workout)
        {
            if (id != workout.Id)
            {
                return NotFound();
