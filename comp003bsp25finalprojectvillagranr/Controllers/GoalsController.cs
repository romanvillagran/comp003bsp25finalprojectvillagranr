...
namespace comp003bsp25finalprojectvillagranr.Controllers
{
    public class GoalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,TargetDate")] Goal goal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,TargetDate")] Goal goal)
        {
            if (id != goal.Id)
            {
                return NotFound();
